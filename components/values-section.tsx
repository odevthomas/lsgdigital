    ...
    <section id="valores" className="w-full py-12 md:py-24 bg-gray-50">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          ...
          <div className="mx-auto grid max-w-5xl gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-3 mt-8">
            <div className="flex items-start space-x-2 rounded-lg border bg-white p-4 shadow-sm">
